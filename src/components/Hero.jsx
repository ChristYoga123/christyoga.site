		...
		<>
			<div name="home" className="w-full h-screen bg-gradient-to-b from-black via-black to-gray-800">
				<div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
					...
					<div className="md:shadow-xl md:shadow-blue-400 md:bg-gradient-to-b from-cyan-500 to-blue-800 md:rounded-tl-[10rem] md:rounded-br-[10rem] md:overflow-hidden md:ml-20 mb-20 md:mb-0">
